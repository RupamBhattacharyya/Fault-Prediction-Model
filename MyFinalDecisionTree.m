...
mainMatrix=data;
%inputPredictorAttribute=mainMatrix(2:234,4:23);
inputPredictorAttribute=mainMatrix(2:nLines-1,4:23);
myX_Matrix=cell2mat(inputPredictorAttribute);
%inputClassOutput=mainMatrix(2:234,24);
inputClassOutput=mainMatrix(2:nLines-1,24);
myY_Matrix=cell2mat(inputClassOutput);
%%%%%%%%%%%%%ENDING of LOCALIZING PREDICTOR ATTRIBUTE%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%TRAINING of the PREDICTOR MODEL%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
SimpleTree=fitctree(myX_Matrix,myY_Matrix)
view(SimpleTree)
view(SimpleTree,'mode','graph')
%%%%%%%%%%%%%END of TRAINING of the PREDICTOR MODEL%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%STARTING TESTING the TRAINED MODEL%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%testX= cell2mat(mainMatrix(234:235,4:23));
testX= cell2mat(mainMatrix(nLines-1:nLines,4:23));
predict(SimpleTree,testX)
%%%%%%%%%%%%END of TESTING the TRAINED MODEL%%%%%%%%%%%%%%%%%%%%%%%%%%%%%