...
[centers,U] = fcm(myX_Matrix,2);
maxU = max(U);
index1 = find(U(1,:) == maxU);
index2 = find(U(2,:) == maxU);
plot(myX_Matrix(index1,1),myX_Matrix(index1,2),'ob')
title('::::::::::::Fuzzy c-mean Clustering for fault prediction::::::::::')
hold on
plot(myX_Matrix(index2,1),myX_Matrix(index2,2),'or')
...
resultantMatrix=[matClassPredict(1,4),matClassPredict(1,5),matClassPredict(1,6),matClassPredict(1,7),matClassPredict(1,8),matClassPredict(1,9),matClassPredict(1,10),matClassPredict(1,11),matClassPredict(1,12),matClassPredict(1,13),matClassPredict(1,14),matClassPredict(1,15),matClassPredict(1,16),matClassPredict(1,17),matClassPredict(1,18),matClassPredict(1,19),matClassPredict(1,20);centers(1,4),centers(1,5),centers(1,6),centers(1,7),centers(1,8),centers(1,9),centers(1,10),centers(1,11),centers(1,12),centers(1,13),centers(1,14),centers(1,15),centers(1,16),centers(1,17),centers(1,18),centers(1,19),centers(1,20)]
resultantMatrix1=[matClassPredict(1,4),matClassPredict(1,5),matClassPredict(1,6),matClassPredict(1,7),matClassPredict(1,8),matClassPredict(1,9),matClassPredict(1,10),matClassPredict(1,11),matClassPredict(1,12),matClassPredict(1,13),matClassPredict(1,14),matClassPredict(1,15),matClassPredict(1,16),matClassPredict(1,17),matClassPredict(1,18),matClassPredict(1,19),matClassPredict(1,20);centers(2,4),centers(2,5),centers(2,6),centers(2,7),centers(2,8),centers(2,9),centers(2,10),centers(2,11),centers(2,12),centers(2,13),centers(2,14),centers(2,15),centers(2,16),centers(2,17),centers(2,18),centers(2,19),centers(2,20)]
